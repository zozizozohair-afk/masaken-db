                ...
                <div key={idx} className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-md transition-shadow group">
                  {file.type === 'image' ? (
                    <div className="h-48 w-full bg-gray-100 relative border-b border-gray-100">
                      <img 
                        src={file.url} 
                        alt={`نموذج ${unitModel.name}`} 
                        className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" 
                      />
                      <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors" />
                    </div>
                  ) : (
                    <div className="h-48 w-full bg-gray-50 flex flex-col items-center justify-center border-b border-gray-100">
                      <FileText size={48} className="text-indigo-300 mb-2" />
                  ...
                  <div className="p-4">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="font-bold text-gray-900 truncate" title={`ملف نموذج ${idx + 1}`}>
                        ملف نموذج {idx + 1}
                      </h4>
                      <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-full">
                        {file.type === 'image' ? 'صورة' : 'PDF'}
                      </span>
                    </div>
                    ...
                    <div className="flex gap-3">
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="flex-1 bg-indigo-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-indigo-700 transition-colors flex items-center justify-center gap-2"
                      >
                        <ExternalLink size={16} />
                        عرض
                      </a>
                      <a 
                        ...
                        download
                        className="bg-indigo-50 text-indigo-700 px-4 py-2 rounded-lg text-sm font-medium hover:bg-indigo-100 transition-colors flex items-center justify-center"
                        title="تحميل"
                      >
                        <Download size={16} />
                      </a>
